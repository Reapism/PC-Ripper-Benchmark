...
namespace PC_Ripper_Benchmark.window
{
    ...
    public partial class LoginWindow : Window
    {
        ...
        public LoginWindow()
        {
            ...
            loginButton.BorderThickness = new Thickness(3);
            signUpButton.BorderThickness = new Thickness(3);
            resetPasswordButton.BorderThickness = new Thickness(3);

            loginButton.BorderBrush = Brushes.White;
            signUpButton.BorderBrush = Brushes.White;
            resetPasswordButton.BorderBrush = Brushes.White;
            emailTextBox.Focus();
        }
